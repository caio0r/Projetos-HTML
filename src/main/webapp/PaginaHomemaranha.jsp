        ...
        <section>
            <div class="container">
                <div class="left-side">
                    <div class="itens">
                        <div class="select-image">
                            <img src="imagens/homemAranha.png" alt="Product Image" width="1000" height="700" >
                        </div>
                ...
                <div class="right-side">
                    <div class="content">
                        <h6>LIVRARIA JOTA</h6>
                        <h1>Homem Aranha - Novo começo</h1>
                        <p>Uma nova e espetacular era começa aqui! Leitores de todas as idades poderão vivenciar as novíssimas aventuras do Homem-Aranha e de seus incríveis amigos! Peter Parker já teve que lidar com vilões mortais e heróis lendários, mas a vida no Ensino Médio pode ser seu maior desafio até agora. Por sorte, ele vai ter uma ajudinha de seus amigos. Miles Morales e Gwen Stacy! (Marvel Action: Spider-Man (2018) 1-6)</p>
                        <p>Editora Panini </p>
                        <div class="prices">
                    ...
                    <div class="options">
                        ...
                        <a href="http://localhost:8080/AgendaOnline/Carrinho.jsp" class="button"><img src="imagens/iciconecarrinho.png" alt="Cart Icon" width="35" height="40" > Adicionar ao carrinho</a>
                    </div>
                </div>
            </div>
        </section>
