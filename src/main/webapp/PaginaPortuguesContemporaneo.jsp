...
<head>
    ...
    <title>PortuguesContemporaneo</title>
        ...
        <section>
            <div class="container">
                <div class="left-side">
                    <div class="itens">
                        <div class="select-image">
                            <img src="imagens/portuguescontemporaneo.png" alt="Product Image" width="1000" height="700" >
                        </div>
                ...
                <div class="right-side">
                    <div class="content">
                        <h6>LIVRARIA JOTA</h6>
                        <h1>Português Contemporâneo</h1>
                        <p>Obra com perfil contemporâneo, apresentando de forma integrada os conteúdos de literatura, de gramática e de produção textual, com uma organização norteada pelas escolas literárias, estabelecendo relações dialógicas entre obras e autores de diferentes épocas. Apresenta os conteúdos essenciais de gramática com uma abordagem diferenciada, além de incluir capítulos inteiros dedicados à análise linguística. Trabalha o genêro do discurso com perspectiva dos estudos de letramento, com diferentes práticas de leitura e escrita, incluindo gêneros das esferas digital e multimodais.</p>
                        <p>Editora Atual Didáticos </p>
                        <div class="prices">
                            <span class="price">$322,55</span>
                        </div>
                    </div>
                    <div class="options">
                        <div class="amount">
