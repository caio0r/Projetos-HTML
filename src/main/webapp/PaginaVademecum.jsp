            ...
            <div class="container">
                <div class="left-side">
                    <div class="itens">
                        <div class="select-image">
                            <img src="imagens/vademecum.png" alt="Product Image" width="1000" height="700" >
                        </div>
                ...
                <div class="right-side">
                    <div class="content">
                        <h6>LIVRARIA JOTA</h6>
                        <h1>Vade Mecum</h1>
                        <p>Veja a seguir um pouco do que você vai encontrar neste Vade Mecum e entenda a razão de ele ser preferido em meio a tantos outros disponíveis no mercado: - Legislação revista e atualizada a cada edição (ele reúne as normas mais importantes do ordenamento jurídico) tudo selecionado com base na grade curricular das principais faculdades de Direito e em editais de concursos para carreiras jurídicas; - Notas remissivas e índices são várias correlações entre as matérias e índices multifuncionais, que ajudarão você a rapidamente pesquisar por assunto, ordem alfabética, cronológica, pelo número do diploma ou por seu tema; - Dicas de pesquisa (legal design) - tutorial nas páginas iniciais sobre como consultar a legislação e manusear seu Vade Mecum. Além de tudo isso, a partir desta edição, uma NOVIDADE: Saraiva Conecta: acesso exclusivo e gratuito à plataforma de conteúdos complementares ao livro, na qual você terá disponível: Legislação adicional diplomas que completam o extenso conteúdo impresso da obra, para você consultar em qualquer lugar; Materiais complementares para estudo; Serviço Atualize seu Código atualização semanal de todo o conteúdo impresso. Tradição, organização e estrutura, aliadas à confiabilidade da marca Saraiva Jur, explicam por que o Vade Mecum Saraiva é há mais de 15 anos o produto de legislação mais vendido no mercado        
							<p>Editora Saraiva Jur </p>
                        <div class="prices">
