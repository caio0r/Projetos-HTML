            ...
            <div class="container">
                <div class="left-side">
                    <div class="itens">
                        <div class="select-image">
                            <img src="imagens/opoderdoagora.png" alt="Product Image" width="1000" height="700" >
                        </div>
                ...
                <div class="right-side">
                    ...
                    <div class="options">
                        <div class="amount">
                            <div class="minus">
                                <img src="iconedemenos.png" alt="Minus Icon" width="25" height="25">
                            </div>
                            <span>0</span>
                            <div class="plus">
                                <img src="iconedemais.png" alt="Plus Icon" width="25" height="25" >
                            </div>
                        </div>
                        <a href="http://localhost:8080/AgendaOnline/Carrinho.jsp" class="button"><img src="iconecarrinho.png" alt="Cart Icon" width="35" height="40" > Adicionar ao carrinho</a>
                    </div>
                </div>
            </div>
        </section>
